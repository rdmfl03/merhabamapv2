...
export function PublicCtaSection({
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-2.5 sm:py-3">
      <Card className="relative overflow-hidden border-brand/25 bg-brand text-brand-foreground shadow-[0_26px_64px_-30px_rgba(227,10,23,0.5)]">
        ...
        <CardContent className="relative space-y-3 p-4 sm:p-5">
          <div className="grid gap-2.5 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          ...
          <div className="flex flex-col gap-2.5 border-t border-white/12 pt-2.5 sm:flex-row sm:flex-wrap">
