...
import { submitEventReport } from "@/server/actions/events/submit-event-report";
import { idleEventActionState } from "@/server/actions/events/shared";

type EventReportFormProps = {
  eventId: string;
  locale: "de" | "tr";
  returnPath: string;
