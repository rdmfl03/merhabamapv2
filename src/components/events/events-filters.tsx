...
export function EventsFilters({
  ...
  return (
    <form
      ...
      className="grid gap-3 rounded-[1.75rem] border border-border bg-white/90 p-4 shadow-soft sm:grid-cols-2 xl:grid-cols-[1.2fr_0.75fr_0.75fr_0.75fr_auto_auto]"
    >
