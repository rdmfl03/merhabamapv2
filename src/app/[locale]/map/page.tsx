    ...
    <>
      ...
      <CityDiscoveryOverview
        ...
        labels={{
          ...
          categoriesFilterLabel: t("map.categoriesFilterLabel"),
          categoriesFilterHint: t("map.categoriesFilterHint"),
          categoriesDropdownAll: t("map.categoriesDropdownAll"),
          categoriesDropdownMultiple: t("map.categoriesDropdownMultiple"),
