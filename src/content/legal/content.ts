      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Harita görünümleri istemci tarafında yüklenir. Üretim ortamında NEXT_PUBLIC_MAPTILER_API_KEY tanımlıysa MapTiler (Pastel raster) karoları kullanılır; anahtar yoksa OpenStreetMap proje sunucularından (tile.openstreetmap.org) standart karolar yüklenir. MapTiler yüklemesinde tekrarlayan hatalar oluşursa uygulama OpenStreetMap’e geçebilir; bu sırada istekler ilgili karo sunucusuna gider.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Kartenkacheln werden im Browser geladen. Ist in der ausgelieferten Konfiguration NEXT_PUBLIC_MAPTILER_API_KEY gesetzt, werden Rasterkacheln von MapTiler („Pastel“) bezogen; ohne Schlüssel nutzen wir die Standardkacheln der OpenStreetMap-Projektserver unter tile.openstreetmap.org. Bei wiederholten Ladefehlern mit MapTiler kann die Anwendung automatisch auf OpenStreetMap wechseln; dabei werden Anfragen an den jeweiligen Kachelserver gerichtet.",
